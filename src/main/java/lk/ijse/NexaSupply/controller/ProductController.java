...
public class ProductController {
    ...
    public CommonResponse updateProduct(@Valid @RequestBody ProductRequestDTO requestDTO) {
        ...
        return new CommonResponse(0, dto, "Product updated successfully");
    }
    ...
    public CommonResponse getAllProducts() {
        ...
        return new CommonResponse(0, allActiveProducts, "All active products successfully");
    }
    ...
    public CommonResponse getProductByCode(@PathVariable String productCode) {
        ...
        return new CommonResponse(0, productByCode, "Product fetched successfully");
    }
    ...
    public CommonResponse getProductsByCategory(@PathVariable String categoryCode) {
        ...
        return new CommonResponse(0, productsByCategory, "All products fetched successfully");
    }
    ...
    public CommonResponse getProductsByLowStock() {
        ...
        return new CommonResponse(0, lowStockProducts, "All low stock products fetched successfully");
    }
    ...
    public CommonResponse searchProducts(@RequestParam String query) {
        ...
        return new CommonResponse(0, searchResults, "Search results fetched successfully");
    }
    ...
    public CommonResponse deleteProduct(@PathVariable String productCode) {
        ...
        return new CommonResponse(0, "Product deleted successfully", "Successfully deleted product");
    }
